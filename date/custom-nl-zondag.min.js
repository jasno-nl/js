...
void 0 !== dpicker && dpicker.on("open", (function (e) {
    ...
    if (e.select && -1 != zondagen.indexOf(this.get("select").pick)) $("input[data-name='Eventtype']").val("JASNO op Zondag"), $("input[data-name='Evenement']").val("Ja"), tpicker.clear(), tpicker.set("enable", !0), tpicker.set({
        interval: 30,
        min: [11, 0],
        max: [15, 0]
